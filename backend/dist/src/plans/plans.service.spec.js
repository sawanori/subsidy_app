...
describe('PlansService', () => {
    ...
    describe('addAction', () => {
        ...
        it('should add action to plan successfully', async () => {
            ...
            prismaService.action.create.mockResolvedValue(newAction);
    ...
    describe('updateAction', () => {
        ...
        it('should update action successfully', async () => {
            prismaService.action.findUnique.mockResolvedValue(mockAction);
            const updatedAction = { ...mockAction, ...actionData };
            prismaService.action.update.mockResolvedValue(updatedAction);
        ...
        it('should throw ForbiddenException when user does not own application', async () => {
            ...
            prismaService.action.findUnique.mockResolvedValue(otherUserAction);
